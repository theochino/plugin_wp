...
* Plugin URI: https://www.repmyblock.nyc/wp_plugin
* Description: Plugin to connect the Rep My Block tools to a Word Press website.
* Version: 1.0
* Author: RepMyBlock
* Author URI: https://www.repmyblock.nyc
**/
...
function repmyblock_initpage(){
        echo "<h2><span class=\"dashicons dashicons-smiley\"></span> RepMyBlock Admin Pages</h2>";
}
